...
const Footer = () => {
    ...
    const handleShare = (e: React.MouseEvent) => {
        ...
        if (navigator.share) {
            navigator.share({
                title: "MyAttendance",
                text: "Track your attendance subject-wise. Check it out!",
                url: window.location.href,
            }).catch(console.error)
        } else {
            const url = `https://api.whatsapp.com/send?text=${encodeURIComponent("Track your attendance: " + window.location.href)}`
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 py-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="text-center md:text-left">
                        <span className="text-lg font-black text-white">MyAttendance</span>
