    ...
    return (
        <div className="relative overflow-hidden" style={{ background: "var(--bg-primary)" }}>
            ...
            <div
                ...
                style={{
                    background: "radial-gradient(ellipse 70% 40% at 50% -5%, rgba(99,102,241,0.18), transparent)",
                }}
            />
            ...
            <section className="relative z-10 max-w-5xl mx-auto px-6 pt-28 pb-24 text-center">
                <motion.div variants={stagger} initial="hidden" animate="show">
                    ...
                    <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20">
                        ...
                        <Link href="#how-it-works" className="text-sm font-medium flex items-center gap-1.5 transition-colors" style={{ color: "var(--text-secondary)" }}>
            ...
            {/* FEATURES - CARD STACK WITH SPREAD EFFECT */}
            <section className="relative z-10 max-w-6xl mx-auto px-6 pb-24">
                ...
                >
                    ...
                    <p className="text-base max-w-xl mx-auto" style={{ color: "var(--text-secondary)" }}>
                        Built around the real problems students face with attendance
                    </p>
                </motion.div>

                {/* Card Stack Container */}
                <motion.div
                    className="relative flex flex-wrap justify-center items-center gap-0 md:gap-0"
                    initial="rest"
                    whileHover="hover"
                    animate="rest"
                    variants={{
                    ...
                    {features.map((f, i) => (
                        <motion.div
                            ...
                            variants={{
                                rest: {
                                    scale: 1,
                                    rotate: (i - 2) * 1.5, // slight fan rotation
                                    x: (i - 2) * -12,      // overlap horizontally
                                    zIndex: 10 - i,
                        ...
                        >
                            <div
                                className="h-full p-6 rounded-2xl backdrop-blur-sm transition-all duration-300"
                                style={{
                            ...
                            >
                                {/* Icon */}
                                <div
                                    className="w-12 h-12 rounded-xl flex items-center justify-center mb-5 text-indigo-400"
                                    style={{
            ...
            {/* HOW IT WORKS*/}
            <section id="how-it-works" className="relative z-10 py-24" style={{ borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", background: "rgba(255,255,255,0.015)" }}>
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                        {steps.map((s, i) => (
                            ...
                            >
                                {i < steps.length - 1 && (
                                    <div className="hidden md:block absolute top-5 left-full w-full h-px z-0" style={{ background: "linear-gradient(to right, var(--border), transparent)" }} />
                                )}
            ...
            <section className="relative z-10 max-w-3xl mx-auto px-6 py-24 text-center">
                ...
                <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left">
                    {[
                        ...
                        <motion.div key={i} variants={fadeUp} className="flex items-start gap-2.5 card p-3.5 text-sm" style={{ color: "var(--text-secondary)" }}>
            ...
            <section className="relative z-10 py-24" style={{ borderTop: "1px solid var(--border)", background: "rgba(255,255,255,0.015)" }}>
            ...
            <section className="relative z-10 max-w-3xl mx-auto px-6 py-24 text-center">
                <motion.div initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
                    <div className="card p-10" style={{ background: "linear-gradient(135deg, rgba(99,102,241,0.12), rgba(59,130,246,0.08))" }}>
