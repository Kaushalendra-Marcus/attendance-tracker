  ...
  return (
    <div className="relative overflow-hidden" style={{ background: "var(--bg-primary)" }}>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pb-24">
        ...
        <div className="hidden md:block">
          ...
          >
            {features.map((f, i) => (
              ...
              >
                <div
                  className="h-full p-6 rounded-2xl backdrop-blur-sm"
                  style={{
                ...
                >
                  ...
                  <div className="mt-3 text-xs flex items-center gap-1" style={{ color: "var(--text-muted)" }}>
        ...
        {/* MOBILE/TABLET VERSION: Grid (visible below md) */}
