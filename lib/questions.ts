...
export const ALL_QUESTIONS: Question[] = [
    ...
    { id: 3, question: "Time complexity of binary search?", options: ["O(n)", "O(nÂ²)", "O(log n)", "O(1)"], answer: "O(log n)", tags: ["#tech", "#cs"] },
    ...
    { id: 29, question: "How many programmers to change a light bulb?", options: ["1", "2", "None â€” it's a hardware problem", "Depends on the framework"], answer: "None â€” it's a hardware problem", tags: ["#funny"] },
    ...
    { id: 39, question: "Speed of light approximately?", options: ["3 Ã- 10â¸ m/s", "3 Ã- 10â¶ m/s", "3 Ã- 10Â¹â° m/s", "3 Ã- 10â´ m/s"], answer: "3 Ã- 10â¸ m/s", tags: ["#general"] },
